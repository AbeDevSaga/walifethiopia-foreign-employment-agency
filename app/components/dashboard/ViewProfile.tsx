...
const ViewProfile: React.FC<ViewUserProps> = ({ user, closeViewUser }) => {
  return (
    <div 
      ...
      onClick={closeViewUser} // Close when clicking outside
    >
      <div 
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className="w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
            {user.profileImage ? (
              <img 
                src={typeof user.profileImage === "string" ? user.profileImage : (user.profileImage && "src" in user.profileImage ? user.profileImage.src : undefined)} 
                alt="Profile" 
