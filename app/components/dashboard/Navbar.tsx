...
function Navbar({ onToggleSidebar }: NavbarProps) {
  ...
  return (
    <div className="navbar flex flex-col md:flex-row lg:flex-row items-center justify-between border border-blue-500 lg:py-4 px-2 md:px-6 lg:px-8 space-x-2 space-y-2">
